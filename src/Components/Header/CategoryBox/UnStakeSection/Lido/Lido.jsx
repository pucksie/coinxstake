...
const Lido = ({amount, setAmount}) => {
      ...
      if(!address) {
        ...
        return {
          ...
          function : () => {
            ...
            if (amount > formatEther(stakeBalance)) {
              alert('You cant withdraw more than staked USDT')
              return
            }
            unstake({
  ...
  return (
    <div className="lido">
      <p>
        USDT must be staked for a minimum of 7 days before unstaking.
      </p>
      <form action method="post">
        <div className="lido-input-wrapper">
          <label htmlFor="lidoAmount">
            <span className="lido-input-wrapper_logo">
              {/* <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <span className="lido-input">
              <input
                ...
                placeholder=" "
                className="lido__input"
              />
              <span>Amount</span>
            </span>
            <span className="lido-btn">
        ...
        <div className="lido-btn-wrapper">
          <button 
          onClick={unstakeButton().function}
          type="button">{unstakeButton().title}</button>
        </div>
      </form>
      <div className="data-container">
        <div className="data_box">
          <p className="text-data">Your Stake Balance</p>
          <p>{stakeBalance ? formatEther(stakeBalance) : 0} USDT</p>
        </div>
        {/* <div className="data_box">
